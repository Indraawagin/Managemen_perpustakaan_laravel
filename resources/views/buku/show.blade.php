                            ...
                            <div class="form-group{{ $errors->has('lokasi') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" name="lokasi" disabled="">
                                        <option value="web" {{$data->lokasi === "web" ? "selected" : ""}}>Rak Buku Web
                                        </option>
                                        <option value="AI" {{$data->lokasi === "AI" ? "selected" : ""}}>Rak Buku AI
                                        </option>
                                        <option value="Design" {{$data->lokasi === "Design" ? "selected" : ""}}>Rak Buku
                                            Graphic Design
                                        </option>
                                    </select>
                                </div>
