        ...
        <div class="clearfix">
          <div class="float-left">
            ...
            <div class="fluid-container">
              <h3 class="font-weight-medium text-left mb-0">{{$transaksi->count()}}</h3>
            </div>
          </div>
        </div>
      ...
      <div class="card-body">
        <div class="clearfix">
          <div class="float-left">
            ...
            <div class="fluid-container">
              <h3 class="font-weight-medium text-left mb-0">{{$transaksi->where('status', 'pinjam')->count()}}</h3>
            </div>
          </div>
        </div>
        <p class="text-muted mt-3 mb-0">
      ...
      <div class="card-body">
        <div class="clearfix">
          <div class="float-left">
            ...
            <div class="fluid-container">
              <h3 class="font-weight-medium text-left mb-0">{{$buku->count()}}</h3>
            </div>
          </div>
        </div>
        <p class="text-muted mt-3 mb-0">
      ...
      <div class="card-body">
        <div class="clearfix">
          <div class="float-left">
            ...
            <div class="fluid-container">
              <h3 class="font-weight-medium text-left mb-0">{{$anggota->count()}}</h3>
            </div>
          </div>
        </div>
        <p class="text-muted mt-3 mb-0">
